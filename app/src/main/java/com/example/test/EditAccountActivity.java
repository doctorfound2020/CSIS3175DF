...
/**
 * Edit AccountActivity.java
 * This class simply has the same code as SignUpActivity.java, with some variable changes.
 * If user wants to edit account, they basically create a whole new account, and its inserted into database.
 * Their old account can still be accessed. Unable to figure out how to delete specific row, or user info.
 */
        ...
        btnToSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(SU_Username == "" || SU_Password == "" || SU_PasswordConfirm == "" || SU_FullName == "" || SU_Phone == "" || SU_Email == "" || SU_Birthday == "" || SU_Address == ""){
                    Toast toastEmpty = Toast.makeText(EditAccountActivity.this, "All fields must be filled", Toast.LENGTH_LONG);
                    toastEmpty.show();
                    isValid = false;
                }
                if((SU_Password.equals(SU_PasswordConfirm)) == false){
                    Toast toastMustMatch = Toast.makeText(EditAccountActivity.this, "Both passwords must match", Toast.LENGTH_LONG);
                    toastMustMatch.show();
                    isValid = false;
                }
                ...
                if(isValid == true){
                    ...
                    Toast toastMustMatch = Toast.makeText(EditAccountActivity.this, "Please check for errors", Toast.LENGTH_LONG);
                    toastMustMatch.show();
                }
            }
        });
